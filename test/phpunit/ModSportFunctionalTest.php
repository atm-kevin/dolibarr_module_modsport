...
/**
 * \file    test/phpunit/ModSportFunctionalTest.php
 * \ingroup modsport
 ...
 *
 * @package Testmodsport
 */
class ModSportFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/modsport/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('modsport/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/modsport/admin/about.php');
		$this->authenticate();
		return $this->assertContains('modsport/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('modsportwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modModSport_ModSportTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modModSport_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
